...
ng.rwb.colors1 <- colorRampPalette(c("red", "white", "blue"))
ng.rwb.colors2 <- colorRampPalette(c("red", "white", "blue"), space = "Lab")
ng.rb.colors2 <- colorRampPalette(c("red", "blue"), space = "Lab")
ng.ob.colors2 <- colorRampPalette(c("orange", "blue"), space = "Lab")
ng.owb.colors2 <- colorRampPalette(c("orange", "white", "blue"), space = "Lab")
ng.wr.colors2 <- colorRampPalette(c("white", "red"), space = "Lab")
ng.rw.colors2 <- colorRampPalette(c("red", "white"), space = "Lab")
